...
if ((!unfrozenTestnet && plan.status !== 'DRY_RUN_ONLY') || plan.mainnetDeploymentPerformed !== false) throw new Error('SAFE_BUNDLE_PLAN_UNSAFE');
if (!unfrozenTestnet && (plan.sourceCommit !== '8790b635ba55512e5d0e295fb1217a3993ecdafb' || plan.sourceVerification?.mode !== 'FROZEN_SOURCE_COMMIT')) throw new Error('SAFE_BUNDLE_SOURCE_MISMATCH');
