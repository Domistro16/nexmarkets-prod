...
const required = [
  ...
  'builder_profile','builder_follow','project_watchlist','builder_milestone','builder','builder_membership','primary_sale_accounting',
  'distribution_agent','distribution_agent_log'
];
...
if (!sql.includes("chain_id IN (4663,46630,8453,84532)")) throw new Error('Multi-network chain policy missing');
