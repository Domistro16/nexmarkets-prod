...
for (const path of ['deployments/robinhood-mainnet.bootstrap.json','deployments/robinhood-testnet.bootstrap.json','deployments/base-mainnet.bootstrap.json','deployments/base-sepolia.bootstrap.json']) {
