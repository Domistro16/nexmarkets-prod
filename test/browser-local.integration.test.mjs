...
test('local browser workflow follows Builder request and holder transaction lifecycle', async (t) => {
  const store = new MemoryStore(); const wallet = Wallet.createRandom(); const safe = Wallet.createRandom(); const server = createApiServer({ store, secureCookies: false, orderPolicy: { protocolAdminSafe: safe.address, transactionTargets: { MINT: '0x7777777777777777777777777777777777777777', EDITION_CREATE: '0x8888888888888888888888888888888888888888' } } });
