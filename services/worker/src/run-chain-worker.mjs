...
const worker = new ChainLifecycleWorker({ chainId, rpcUrl: chainId === 46630 ? process.env.RH_TESTNET_RPC_URL : process.env.RH_MAINNET_RPC_URL, finalityDepth: Number(process.env.ROBINHOOD_FINALITY_BLOCKS ?? 12), protocolAdminSafe: process.env.PROTOCOL_ADMIN_SAFE_ADDRESS, factoryAddress: process.env.NEX_PASS_FACTORY_ADDRESS });
